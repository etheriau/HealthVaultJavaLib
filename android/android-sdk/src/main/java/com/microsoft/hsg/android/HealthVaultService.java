...
public class HealthVaultService {
     ...
     * @param ctx the ctx
     */
    public static void initialize(HealthVaultSettings settings) {
        instance = new HealthVaultService(settings);
    }
    ...
    private HealthVaultService(HealthVaultSettings settings) {
        ...
        if (settings.getAppId() != null
                && settings.getAuthenticationSecret() != null)
        {
     ...
     * @return the intent
     */
    public Intent connect(Context ctx) {
        Intent intent = null;
